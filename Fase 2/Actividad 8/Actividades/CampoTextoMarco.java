...
public class CampoTextoMarco extends JFrame {
   ...
   private final JLabel etiquetaContrasenia;
   ...
   public CampoTextoMarco() {
      ...
      etiqueta1 = new JLabel("Escriba 10 columnas");
      campoTexto1 = new JTextField(10);
      etiqueta1.setToolTipText("Estiqueta de 10 columnas");
      campoTexto1.setToolTipText("Estiqueta de 10 columnas");
      add(etiqueta1);
      add(campoTexto1); // agrega campoTexto1 a JFrame

      // construye campo de texto con texto predeterminado
      etiqueta2 = new JLabel("Escriba el texto aqui");
      campoTexto2 = new JTextField("Escriba el texto aqui");
      etiqueta2.setToolTipText("Estiqueta Escriba el texto aqui");
      campoTexto2.setToolTipText("Estiqueta Escriba el texto aqui");
      add(etiqueta2);
      add(campoTexto2); // agrega campoTexto2 a JFrame

      // construye campo de texto con texto predeterminado y 21 columnas
      etiqueta3 = new JLabel("Campo de texto no editable");
      campoTexto3 = new JTextField("Campo de texto no editable", 21);
      etiqueta3.setToolTipText("Estiqueta texto no editable");
      campoTexto3.setToolTipText("Estiqueta texto no editable");
      ...
      etiquetaContrasenia = new JLabel("la contraseña");
      campoContrasenia = new JPasswordField("Texto oculto");
      etiquetaContrasenia.setToolTipText("Estiqueta de la contraseña");
      campoContrasenia.setToolTipText("Estiqueta de la contraseña");
      add(etiquetaContrasenia);
      add(campoContrasenia);
      // agrega campoContrasenia a JFrame
